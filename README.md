...
> 你用大白话报体重/饮食/运动，它结构化存档、按松松配额给碳蛋脂区间、用「看趋势不看单日」判断你是不是真在变好，并生成一个**本地可视化看板**（达成里程碑还有全屏烟花彩蛋）。**全程本地、不联网。**
...
- **🧭 科学指导** —— 按 性别 × 阶段（减脂/增肌/维持）给配额区间；7 日均 + 周均看真趋势；平台期排查
- **🤝 看板陪伴** —— 本地可视化看板 + 每日夸夸 + 里程碑烟花彩蛋
